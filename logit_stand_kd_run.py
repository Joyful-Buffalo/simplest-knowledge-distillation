...
def zscore_logits(logits, tau, eps=1e-6):
    mu = logits.mean(dim=1, keepdim=True)
    var = logits.var(dim=1, keepdim=True, unbiased=False)
...
if __name__ == '__main__':
    main()
# Teacher acc: 98.86
# StudentCNN acc: 97.59|space acc: 98.00|continue acc: 98.09
# StudentMLP acc: 95.26|space acc: 95.54|continue acc: 96.09
